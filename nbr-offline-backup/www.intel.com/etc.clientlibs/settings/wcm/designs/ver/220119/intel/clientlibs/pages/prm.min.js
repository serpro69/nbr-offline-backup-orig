...
(function(document, $) {
    ...
    $(document).on("selected", ".cq-dialog-tab-showhide", function() {
        showHide($(this));
    });

    $(document).on("change", ".cq-dialog-tab-showhide", function() {
        showHide($(this));
    });
    ...
    function showHide(el){
        el.each(function(i, element) {
            ...
            if ($(element).data("select")) {
				...
				$(target).find(".coral-Form-field").each(function( i ) { 
                ...
                $(target).find(".coral-InputGroup-input").each(function( i ) { 
                ...
                if(value){
                    $(target+'.'+value).removeClass("hide");
                  	$(target+'.'+value).find(".coral-Form-field").each(function( i ) { 
                    ...
                    $(target+'.'+value).find(".coral-InputGroup-input").each(function( i ) { 
